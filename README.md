...
With these two experiments, I explore Reinforcement Learning using TensorFlow.js to train an existing model on how to 1) recognize the six sides of a dice and to 2) recognize random scribbles apart.
